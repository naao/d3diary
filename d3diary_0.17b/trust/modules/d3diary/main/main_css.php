...
$tpl->assign( array(
	...
	'main_width' => - (int)$xoopsModuleConfig['rightarea_width'] -6 ,
	'main_body_width' => (int)$xoopsModuleConfig['rightarea_width'] +8 ,
	'side_width' => (int)$xoopsModuleConfig['rightarea_width'] ,
) ) ;
