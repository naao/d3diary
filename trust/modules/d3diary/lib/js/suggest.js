var D3diaryUnameSuggest = Class.create();
D3diaryUnameSuggest.prototype = {
	...
	initialize: function(baseurl, e_input, e_slist, e_hidden, e_list, enc){
		...
		this._suggest = new D3diarySuggest(baseurl, e_input, e_slist, enc);
...
var D3diarySuggest = Class.create();
D3diarySuggest.prototype = {
	initialize: function(baseurl, input, list, enc){
		...
		this._baseurl      = baseurl;
		this._posturl      = baseurl + "index.php?page=xoops_uname";
		this._enc          = enc;
		this.tagText       = $(input);
